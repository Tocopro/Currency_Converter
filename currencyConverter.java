...
public class currency_converter {
    // function to convert Kenya Shilling to Dollars
    // using java swing
    public static <Jlabel> void converter()
    {
        ...
        // crating two text fields
        // one for shilling and for the dollar
        JTextField t1, t2;
        // creating three buttons;
        JButton b1, b2, b3;
        // naming the labels and settings
        // the bounds for the labels
        l1 = new Jlabel("Shilling:");
        ...
        b1.addActionListener(new ActionListener()
        {
            ...
            public void actionPerformed(ActionEvent e)
            {
                ...
                // converting Shillings to Dollars
                double d1 = (d / 101.25);
